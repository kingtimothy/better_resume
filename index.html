...
<head>
	<meta charset="utf-8" />
	<title>Timothy King | Resume</title>
...
<body>
	...
	<header>
		<h1>Timothy King</h1>
		<p>Graduate Aeronautical Engineer | Aviation Management</p>
	</header>
	...
	<div class="container">
		...
		<section class="education">	
			<h2>Bachelor of Aeronautical Engineering (Honours) - the University of Sydney <br/>
				Graduate Certificate in Aviation Management - Griffith University.</h2>
		</section>
		...
		<section class="experience">
			<div class="row">
				<div class="grid-2">
					<h2>Strategic Airline Analyst - Scheduling and Data Analysis</h2>
